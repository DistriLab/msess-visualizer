...
-- Button rendering
renderButtons ::
     Int -> Maybe Int -> Int -> Maybe Int -> Int -> Maybe Int -> Picture
renderButtons count0 advancedCount0 count5 advancedCount5 count10 advancedCount10 =
